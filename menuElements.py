...
mainMenu = ["Update profile information","Recipes", "Fitness", "Shopping", "Family Members", "Food Log", "Logout"]
...
fitnessMenu = ["Create new workout", "Workout plan", "Delete workout", "Set weight goal", "Go back to main menu"]
